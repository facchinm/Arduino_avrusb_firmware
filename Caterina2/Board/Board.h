...
extern "C" {
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define USB_DESCRIPTOR_STRING L"Arduino Uno"
			#elif (PRODUCTID == ARDUINO_MEGA_PID)
			#define USB_DESCRIPTOR_STRING L"Arduino Mega2560"
			#elif (PRODUCTID == ARDUINO_ADK_PID)
			#define USB_DESCRIPTOR_STRING L"Arduino MegaADK"
			...
			#define USB_DESCRIPTOR_STRING L"YUN101 BL"
